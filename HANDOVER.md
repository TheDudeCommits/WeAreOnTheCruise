...
- Release details: [RELEASE.md](docs/overhaul/RELEASE.md). The final response in the releasing session supplies the verified immutable URL and commit. Do not mistake the older September 7 Preview for the latest documentation deployment.

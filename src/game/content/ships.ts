 ...
 * Pickup radii are ~4× the v2 values (~140 m, the broadside's reach): ships sink 60–150 m away, and their treasure
 * should fly to the hull instead of being chased or left to drift away.
 */
export const SHIPS: Readonly<Record<ShipId, ShipDef>> = {
  'dawn-ram': {
    ...
    broadsideGuns: 3, pickupRadius: 140, special: 'second-wind', ultimate: 'ramming-speed', startingWeapon: 'broadside',
  ...
  sunlion: {
    ...
    broadsideGuns: 4, pickupRadius: 136, special: 'lionburst', ultimate: 'sunfire-barrage', startingWeapon: 'broadside',
  ...
  yellowfin: {
    ...
    broadsideGuns: 3, pickupRadius: 136, special: 'deep-dive', ultimate: 'torpedo-swarm', startingWeapon: 'broadside',
  ...
  'grand-galley': {
    ...
    broadsideGuns: 5, pickupRadius: 150, special: 'chefs-banquet', ultimate: 'kitchen-inferno', startingWeapon: 'broadside',
  ...
  seawarden: {
    ...
    broadsideGuns: 5, pickupRadius: 136, special: 'signal-flare', ultimate: 'admirals-judgment', startingWeapon: 'broadside',
  ...
  'white-leviathan': {
    ...
    broadsideGuns: 7, pickupRadius: 155, special: 'seaquake', ultimate: 'tidal-colossus', startingWeapon: 'broadside',

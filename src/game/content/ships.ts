...
export const SHIPS: Readonly<Record<ShipId, ShipDef>> = {
  'dawn-ram': {
    ...
    modelKey: 'going-merry', length: 34, beam: 11, hp: 240, armor: 0, maxSpeed: 27, accel: 7.5, turnRate: 0.95, mass: 350,
  ...
  sunlion: {
    ...
    modelKey: 'thousand-sunny', length: 46, beam: 17, hp: 300, armor: 1, maxSpeed: 25, accel: 6.2, turnRate: 0.8, mass: 600,
  ...
  yellowfin: {
    ...
    modelKey: 'polar-tang', length: 44, beam: 13, hp: 260, armor: 1, maxSpeed: 26, accel: 7, turnRate: 0.85, mass: 520,
  ...
  'grand-galley': {
    ...
    modelKey: 'baratie', length: 56, beam: 30, hp: 420, armor: 3, maxSpeed: 19, accel: 4.2, turnRate: 0.55, mass: 1400,
  ...
  seawarden: {
    ...
    modelKey: 'navy-galleon', length: 58, beam: 17, hp: 380, armor: 3, maxSpeed: 22, accel: 5, turnRate: 0.62, mass: 1100,
  ...
  'white-leviathan': {
    ...
    modelKey: 'moby-dick', length: 84, beam: 24, hp: 540, armor: 4, maxSpeed: 20, accel: 3.6, turnRate: 0.42, mass: 2600,

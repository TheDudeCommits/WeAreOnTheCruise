...
const SCENES = [
  ...
  { name: 'lantern-wisp', sea: 'the-gloam', minute: 5, noGuns: true, spawns: [['lantern-wisp', 10, 55], ['lantern-wisp', 0, 60], ['lantern-wisp', -8, 52], ['lantern-wisp', 18, 64], ['lantern-wisp', 4, -58], ['lantern-wisp', -6, -64]], until: "s.enemies.filter((x) => x.defId === 'lantern-wisp' && x.ai.wl === 1).length >= 2", max: 12, after: 0.3 },

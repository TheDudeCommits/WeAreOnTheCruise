import type { AiPersonality, DebugScene, GameMode, ShipKind, Vec3, WeatherKind } from '../core/contracts';
...
export const SCENARIO_PRESETS: Readonly<Record<DebugScene, ScenarioPreset>> = {
  'calm-sailing': {
    scene: 'calm-sailing', mode: 'explore', weather: 'calm', objective: 'Follow the gulls toward Dawn Archipelago',
    windDirection: 0.35, windStrength: 0.72, currentDirection: -0.2, currentStrength: 0.22,
    player: { id: 'player', kind: 'thousand-sunny', position: v(0, 0), heading: 0 }, rivals: [],
  ...
  'sunny-broadside': {
    ...
    rivals: [
      { id: 'marine-alpha', kind: 'navy-galleon', position: v(-64, -18), heading: Math.PI / 2, ai: 'tactical', damage: 0.28 },
      { id: 'marine-beta', kind: 'navy-galleon', position: v(-116, 55), heading: 0.35, ai: 'aggressive' },
      { id: 'marine-gamma', kind: 'navy-galleon', position: v(-145, -94), heading: 2.4, ai: 'reckless' },
  ...
  'moby-scale': {
    ...
    rivals: [{ id: 'moby', kind: 'moby-dick', position: v(-40, -20), heading: 0, ai: 'tactical' }], islands: [], bounty: 30_000_000,
  },
  'fleet-battle': {
    ...
    rivals: [
      { id: 'marine-vanguard', kind: 'navy-galleon', position: v(-85, -80), heading: 0.15, ai: 'aggressive' },
      { id: 'marine-line', kind: 'navy-galleon', position: v(0, -130), heading: -0.1, ai: 'tactical' },
      { id: 'marine-flanker', kind: 'polar-tang', position: v(105, -65), heading: -0.4, ai: 'reckless' },
  ...
  'damaged-ship': {
    ...
    rivals: [{ id: 'hunter', kind: 'navy-galleon', position: v(-135, -210), heading: 0.1, ai: 'tactical', damage: 0.36 }], islands: [], bounty: 66_000_000,
  },
  'island-discovery': {
  ...
  'perf-fleet': {
    ...
    rivals: [
      ...
      { id: 'perf-6', kind: 'polar-tang', position: v(-245, -20), heading: 1.1, ai: 'reckless' },
      { id: 'perf-7', kind: 'red-force', position: v(245, -20), heading: -1.1, ai: 'aggressive' },
